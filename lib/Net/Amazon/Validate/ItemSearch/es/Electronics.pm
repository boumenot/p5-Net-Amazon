...
package Net::Amazon::Validate::ItemSearch::es::Electronics;
...
sub find_match {
    ...
    die "$value is not a valid value for es::Electronics!\n";
}
...
Net::Amazon::Validate::ItemSearch::es::Electronics - valid search indicies
for the es locale and the Electronics SearchIndex.
