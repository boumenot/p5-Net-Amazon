...
package Net::Amazon::Validate::ItemSearch::es::Watches;
...
sub find_match {
    ...
    die "$value is not a valid value for es::Watches!\n";
}
...
Net::Amazon::Validate::ItemSearch::es::Watches - valid search indicies
for the es locale and the Watches SearchIndex.
