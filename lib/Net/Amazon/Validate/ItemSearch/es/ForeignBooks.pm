...
package Net::Amazon::Validate::ItemSearch::es::ForeignBooks;
...
sub find_match {
    ...
    die "$value is not a valid value for es::ForeignBooks!\n";
}
...
Net::Amazon::Validate::ItemSearch::es::ForeignBooks - valid search indicies
for the es locale and the ForeignBooks SearchIndex.
