...
package Net::Amazon::Validate::ItemSearch::es::VideoGames;
...
sub find_match {
    ...
    die "$value is not a valid value for es::VideoGames!\n";
}
...
Net::Amazon::Validate::ItemSearch::es::VideoGames - valid search indicies
for the es locale and the VideoGames SearchIndex.
