...
package Net::Amazon::Validate::ItemSearch::es::Books;
...
sub find_match {
    ...
    die "$value is not a valid value for es::Books!\n";
}
...
Net::Amazon::Validate::ItemSearch::es::Books - valid search indicies
for the es locale and the Books SearchIndex.
