...
package Net::Amazon::Validate::ItemSearch::es::Keywords;
...
sub find_match {
    ...
    die "$value is not a valid value for es::Keywords!\n";
}
...
Net::Amazon::Validate::ItemSearch::es::Keywords - valid search indicies
for the es locale and the Keywords SearchIndex.
