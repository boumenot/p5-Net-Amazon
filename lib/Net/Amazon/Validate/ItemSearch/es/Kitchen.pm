...
package Net::Amazon::Validate::ItemSearch::es::Kitchen;
...
sub find_match {
    ...
    die "$value is not a valid value for es::Kitchen!\n";
}
...
Net::Amazon::Validate::ItemSearch::es::Kitchen - valid search indicies
for the es locale and the Kitchen SearchIndex.
