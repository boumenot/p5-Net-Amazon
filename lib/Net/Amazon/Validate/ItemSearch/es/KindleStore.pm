...
package Net::Amazon::Validate::ItemSearch::es::KindleStore;
...
sub find_match {
    ...
    die "$value is not a valid value for es::KindleStore!\n";
}
...
Net::Amazon::Validate::ItemSearch::es::KindleStore - valid search indicies
for the es locale and the KindleStore SearchIndex.
