...
package Net::Amazon::Validate::ItemSearch::es::Software;
...
sub find_match {
    ...
    die "$value is not a valid value for es::Software!\n";
}
...
Net::Amazon::Validate::ItemSearch::es::Software - valid search indicies
for the es locale and the Software SearchIndex.
