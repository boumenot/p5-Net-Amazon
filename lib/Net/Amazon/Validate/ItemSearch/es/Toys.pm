...
package Net::Amazon::Validate::ItemSearch::es::Toys;
...
sub find_match {
    ...
    die "$value is not a valid value for es::Toys!\n";
}
...
Net::Amazon::Validate::ItemSearch::es::Toys - valid search indicies
for the es locale and the Toys SearchIndex.
