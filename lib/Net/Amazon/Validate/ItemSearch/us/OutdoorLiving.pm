...
package Net::Amazon::Validate::ItemSearch::us::OutdoorLiving;
...
sub find_match {
    ...
    die "$value is not a valid value for us::OutdoorLiving!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::OutdoorLiving - valid search indicies
for the us locale and the OutdoorLiving SearchIndex.
