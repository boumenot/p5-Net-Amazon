...
package Net::Amazon::Validate::ItemSearch::us::PetSupplies;
...
sub find_match {
    ...
    die "$value is not a valid value for us::PetSupplies!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::PetSupplies - valid search indicies
