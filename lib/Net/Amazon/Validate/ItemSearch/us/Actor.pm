...
package Net::Amazon::Validate::ItemSearch::us::Actor;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Actor!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Actor - valid search indices for the us locale and the Actor operation.
