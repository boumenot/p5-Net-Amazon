...
package Net::Amazon::Validate::ItemSearch::us::OfficeProducts;
...
sub find_match {
    ...
    die "$value is not a valid value for us::OfficeProducts!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::OfficeProducts - valid search indicies
for the us locale and the OfficeProducts SearchIndex.
