...
package Net::Amazon::Validate::ItemSearch::us::Wireless;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Wireless!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Wireless - valid search indicies
