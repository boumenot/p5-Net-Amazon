...
package Net::Amazon::Validate::ItemSearch::us::Shoes;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Shoes!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Shoes - valid search indicies
for the us locale and the Shoes SearchIndex.
