...
package Net::Amazon::Validate::ItemSearch::us::UnboxVideo;
...
sub find_match {
    ...
    die "$value is not a valid value for us::UnboxVideo!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::UnboxVideo - valid search indicies
