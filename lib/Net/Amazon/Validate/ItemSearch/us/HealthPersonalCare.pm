...
package Net::Amazon::Validate::ItemSearch::us::HealthPersonalCare;
...
sub find_match {
    ...
    die "$value is not a valid value for us::HealthPersonalCare!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::HealthPersonalCare;
