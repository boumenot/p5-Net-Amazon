...
package Net::Amazon::Validate::ItemSearch::us::KindleStore;
...
sub find_match {
    ...
    die "$value is not a valid value for us::KindleStore!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::KindleStore - valid search indicies
