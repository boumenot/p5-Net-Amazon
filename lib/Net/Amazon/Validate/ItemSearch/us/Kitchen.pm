...
package Net::Amazon::Validate::ItemSearch::us::Kitchen;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Kitchen!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Kitchen - valid search indicies
for the us locale and the Kitchen SearchIndex.
