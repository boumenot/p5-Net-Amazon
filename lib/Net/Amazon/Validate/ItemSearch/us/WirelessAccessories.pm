...
package Net::Amazon::Validate::ItemSearch::us::WirelessAccessories;
...
sub find_match {
    ...
    die "$value is not a valid value for us::WirelessAccessories!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::WirelessAccessories - valid search indicies
for the us locale and the WirelessAccessories SearchIndex.
