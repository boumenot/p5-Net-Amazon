...
package Net::Amazon::Validate::ItemSearch::us::Baby;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Baby!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Baby - valid search indicies
for the us locale and the Baby SearchIndex.
