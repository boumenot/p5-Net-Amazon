...
package Net::Amazon::Validate::ItemSearch::us::Toys;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Toys!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Toys - valid search indicies
for the us locale and the Toys SearchIndex.
