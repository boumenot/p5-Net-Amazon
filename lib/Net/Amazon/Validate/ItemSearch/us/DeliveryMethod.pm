...
package Net::Amazon::Validate::ItemSearch::us::DeliveryMethod;
...
sub find_match {
    ...
    die "$value is not a valid value for us::DeliveryMethod!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::DeliveryMethod;
