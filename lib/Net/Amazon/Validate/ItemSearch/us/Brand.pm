...
package Net::Amazon::Validate::ItemSearch::us::Brand;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Brand!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Brand - valid search indices for the us locale and the Brand operation.
