...
package Net::Amazon::Validate::ItemSearch::us::VHS;
...
sub find_match {
    ...
    die "$value is not a valid value for us::VHS!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::VHS - valid search indicies
for the us locale and the VHS SearchIndex.
