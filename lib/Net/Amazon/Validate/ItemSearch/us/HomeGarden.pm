...
package Net::Amazon::Validate::ItemSearch::us::HomeGarden;
...
sub find_match {
    ...
    die "$value is not a valid value for us::HomeGarden!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::HomeGarden - valid search indicies
for the us locale and the HomeGarden SearchIndex.
