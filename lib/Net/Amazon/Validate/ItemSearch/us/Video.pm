...
package Net::Amazon::Validate::ItemSearch::us::Video;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Video!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Video - valid search indicies
for the us locale and the Video SearchIndex.
