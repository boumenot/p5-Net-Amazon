...
package Net::Amazon::Validate::ItemSearch::us::ItemPage;
...
sub find_match {
    ...
    die "$value is not a valid value for us::ItemPage!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::ItemPage - valid search indices for the us locale and the ItemPage operation.
