...
package Net::Amazon::Validate::ItemSearch::us::MaximumPrice;
...
sub find_match {
    ...
    die "$value is not a valid value for us::MaximumPrice!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::MaximumPrice - valid search indices for the us locale and the MaximumPrice operation.
