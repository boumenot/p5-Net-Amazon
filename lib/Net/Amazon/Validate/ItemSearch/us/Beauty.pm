...
package Net::Amazon::Validate::ItemSearch::us::Beauty;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Beauty!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Beauty - valid search indicies
for the us locale and the Beauty SearchIndex.
