...
package Net::Amazon::Validate::ItemSearch::us::Merchants;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Merchants!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Merchants - valid search indicies
