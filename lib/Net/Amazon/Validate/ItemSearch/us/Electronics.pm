...
package Net::Amazon::Validate::ItemSearch::us::Electronics;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Electronics!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Electronics - valid search indicies
