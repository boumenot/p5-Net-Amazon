...
package Net::Amazon::Validate::ItemSearch::us::Industrial;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Industrial!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Industrial - valid search indicies
