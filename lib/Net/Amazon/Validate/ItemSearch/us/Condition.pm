...
package Net::Amazon::Validate::ItemSearch::us::Condition;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Condition!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Condition - valid search indices for the us locale and the Condition operation.
