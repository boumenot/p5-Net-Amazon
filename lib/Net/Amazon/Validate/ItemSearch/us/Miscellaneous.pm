...
package Net::Amazon::Validate::ItemSearch::us::Miscellaneous;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Miscellaneous!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Miscellaneous;
