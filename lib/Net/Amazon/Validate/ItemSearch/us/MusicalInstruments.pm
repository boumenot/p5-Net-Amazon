...
package Net::Amazon::Validate::ItemSearch::us::MusicalInstruments;
...
sub find_match {
    ...
    die "$value is not a valid value for us::MusicalInstruments!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::MusicalInstruments;
