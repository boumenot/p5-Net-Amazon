...
package Net::Amazon::Validate::ItemSearch::us::Jewelry;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Jewelry!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Jewelry - valid search indicies
