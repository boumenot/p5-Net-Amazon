...
package Net::Amazon::Validate::ItemSearch::us::Books;
...
sub find_match {
    ...
    die "$value is not a valid value for us::Books!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::Books - valid search indicies
for the us locale and the Books SearchIndex.
