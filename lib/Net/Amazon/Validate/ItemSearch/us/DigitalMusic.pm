...
package Net::Amazon::Validate::ItemSearch::us::DigitalMusic;
...
sub find_match {
    ...
    die "$value is not a valid value for us::DigitalMusic!\n";
}
...
Net::Amazon::Validate::ItemSearch::us::DigitalMusic - valid search indicies
