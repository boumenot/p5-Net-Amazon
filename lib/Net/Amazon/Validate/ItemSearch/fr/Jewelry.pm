...
package Net::Amazon::Validate::ItemSearch::fr::Jewelry;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Jewelry!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Jewelry - valid search indicies
for the fr locale and the Jewelry SearchIndex.
