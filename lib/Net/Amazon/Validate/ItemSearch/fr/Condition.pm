...
package Net::Amazon::Validate::ItemSearch::fr::Condition;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Condition!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Condition - valid search indices for the fr locale and the Condition operation.
