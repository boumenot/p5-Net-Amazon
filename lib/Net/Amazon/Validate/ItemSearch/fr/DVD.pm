...
package Net::Amazon::Validate::ItemSearch::fr::DVD;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::DVD!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::DVD - valid search indicies
for the fr locale and the DVD SearchIndex.
