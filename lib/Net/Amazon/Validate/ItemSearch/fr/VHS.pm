...
package Net::Amazon::Validate::ItemSearch::fr::VHS;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::VHS!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::VHS - valid search indicies
for the fr locale and the VHS SearchIndex.
