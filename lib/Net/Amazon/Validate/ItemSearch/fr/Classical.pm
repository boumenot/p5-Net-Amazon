...
package Net::Amazon::Validate::ItemSearch::fr::Classical;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Classical!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Classical - valid search indicies
for the fr locale and the Classical SearchIndex.
