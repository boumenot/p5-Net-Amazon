...
package Net::Amazon::Validate::ItemSearch::fr::Baby;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Baby!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Baby - valid search indicies
for the fr locale and the Baby SearchIndex.
