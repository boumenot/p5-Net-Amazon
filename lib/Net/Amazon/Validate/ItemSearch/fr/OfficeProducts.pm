...
package Net::Amazon::Validate::ItemSearch::fr::OfficeProducts;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::OfficeProducts!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::OfficeProducts - valid search indicies
for the fr locale and the OfficeProducts SearchIndex.
