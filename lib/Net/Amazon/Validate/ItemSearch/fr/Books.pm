...
package Net::Amazon::Validate::ItemSearch::fr::Books;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Books!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Books - valid search indicies
