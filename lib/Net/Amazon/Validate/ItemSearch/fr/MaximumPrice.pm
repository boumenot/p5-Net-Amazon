...
package Net::Amazon::Validate::ItemSearch::fr::MaximumPrice;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::MaximumPrice!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::MaximumPrice - valid search indices for the fr locale and the MaximumPrice operation.
