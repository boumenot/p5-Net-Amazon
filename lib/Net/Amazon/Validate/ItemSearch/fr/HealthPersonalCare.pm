...
package Net::Amazon::Validate::ItemSearch::fr::HealthPersonalCare;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::HealthPersonalCare!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::HealthPersonalCare - valid search indicies
for the fr locale and the HealthPersonalCare SearchIndex.
