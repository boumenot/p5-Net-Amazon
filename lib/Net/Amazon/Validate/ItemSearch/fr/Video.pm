...
package Net::Amazon::Validate::ItemSearch::fr::Video;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Video!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Video - valid search indicies
for the fr locale and the Video SearchIndex.
