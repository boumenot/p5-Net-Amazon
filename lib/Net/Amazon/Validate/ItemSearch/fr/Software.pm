...
package Net::Amazon::Validate::ItemSearch::fr::Software;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Software!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Software - valid search indicies
for the fr locale and the Software SearchIndex.
