...
package Net::Amazon::Validate::ItemSearch::fr::Electronics;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Electronics!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Electronics - valid search indicies
for the fr locale and the Electronics SearchIndex.
