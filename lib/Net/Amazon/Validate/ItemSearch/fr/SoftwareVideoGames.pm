...
package Net::Amazon::Validate::ItemSearch::fr::SoftwareVideoGames;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::SoftwareVideoGames!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::SoftwareVideoGames - valid search indicies
for the fr locale and the SoftwareVideoGames SearchIndex.
