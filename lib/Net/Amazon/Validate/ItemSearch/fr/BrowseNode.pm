...
package Net::Amazon::Validate::ItemSearch::fr::BrowseNode;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::BrowseNode!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::BrowseNode - valid search indices for the fr locale and the BrowseNode operation.
