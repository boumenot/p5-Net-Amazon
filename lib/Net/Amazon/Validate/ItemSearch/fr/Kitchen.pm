...
package Net::Amazon::Validate::ItemSearch::fr::Kitchen;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Kitchen!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Kitchen - valid search indicies
for the fr locale and the Kitchen SearchIndex.
