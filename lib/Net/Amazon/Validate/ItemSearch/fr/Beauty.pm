...
package Net::Amazon::Validate::ItemSearch::fr::Beauty;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Beauty!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Beauty - valid search indicies
for the fr locale and the Beauty SearchIndex.
