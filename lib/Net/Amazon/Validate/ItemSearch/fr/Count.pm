...
package Net::Amazon::Validate::ItemSearch::fr::Count;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Count!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Count - valid search indices for the fr locale and the Count operation.
