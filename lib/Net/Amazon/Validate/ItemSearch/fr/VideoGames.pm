...
package Net::Amazon::Validate::ItemSearch::fr::VideoGames;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::VideoGames!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::VideoGames - valid search indicies
for the fr locale and the VideoGames SearchIndex.
