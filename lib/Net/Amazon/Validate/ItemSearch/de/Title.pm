...
package Net::Amazon::Validate::ItemSearch::de::Title;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Title!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Title - valid search indices for the de locale and the Title operation.
