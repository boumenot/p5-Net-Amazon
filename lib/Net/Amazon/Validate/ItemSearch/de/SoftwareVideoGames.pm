...
package Net::Amazon::Validate::ItemSearch::de::SoftwareVideoGames;
...
sub find_match {
    ...
    die "$value is not a valid value for de::SoftwareVideoGames!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::SoftwareVideoGames - valid search indicies
for the de locale and the SoftwareVideoGames SearchIndex.
