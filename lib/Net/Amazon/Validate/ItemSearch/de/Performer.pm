...
package Net::Amazon::Validate::ItemSearch::de::Performer;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Performer!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Performer - valid search indices for the de locale and the Performer operation.
