...
package Net::Amazon::Validate::ItemSearch::de::VideoGames;
...
sub find_match {
    ...
    die "$value is not a valid value for de::VideoGames!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::VideoGames - valid search indicies
for the de locale and the VideoGames SearchIndex.
