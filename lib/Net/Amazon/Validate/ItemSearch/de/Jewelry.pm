...
package Net::Amazon::Validate::ItemSearch::de::Jewelry;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Jewelry!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Jewelry - valid search indicies
for the de locale and the Jewelry SearchIndex.
