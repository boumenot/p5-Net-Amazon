...
package Net::Amazon::Validate::ItemSearch::de::Software;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Software!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Software - valid search indicies
for the de locale and the Software SearchIndex.
