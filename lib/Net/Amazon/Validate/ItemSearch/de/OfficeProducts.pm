...
package Net::Amazon::Validate::ItemSearch::de::OfficeProducts;
...
sub find_match {
    ...
    die "$value is not a valid value for de::OfficeProducts!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::OfficeProducts - valid search indicies
