...
package Net::Amazon::Validate::ItemSearch::de::SportingGoods;
...
sub find_match {
    ...
    die "$value is not a valid value for de::SportingGoods!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::SportingGoods;
