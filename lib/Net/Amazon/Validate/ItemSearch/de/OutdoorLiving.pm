...
package Net::Amazon::Validate::ItemSearch::de::OutdoorLiving;
...
sub find_match {
    ...
    die "$value is not a valid value for de::OutdoorLiving!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::OutdoorLiving - valid search indicies
for the de locale and the OutdoorLiving SearchIndex.
