...
package Net::Amazon::Validate::ItemSearch::de::Music;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Music!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Music - valid search indicies
for the de locale and the Music SearchIndex.
