...
package Net::Amazon::Validate::ItemSearch::de::DVD;
...
sub find_match {
    ...
    die "$value is not a valid value for de::DVD!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::DVD - valid search indicies
for the de locale and the DVD SearchIndex.
