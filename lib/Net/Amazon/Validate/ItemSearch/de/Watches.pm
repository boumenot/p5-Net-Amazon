...
package Net::Amazon::Validate::ItemSearch::de::Watches;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Watches!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Watches - valid search indicies
for the de locale and the Watches SearchIndex.
