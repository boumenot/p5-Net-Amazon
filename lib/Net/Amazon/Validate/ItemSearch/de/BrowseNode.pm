...
package Net::Amazon::Validate::ItemSearch::de::BrowseNode;
...
sub find_match {
    ...
    die "$value is not a valid value for de::BrowseNode!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::BrowseNode - valid search indices for the de locale and the BrowseNode operation.
