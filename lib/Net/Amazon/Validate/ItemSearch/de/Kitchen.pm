...
package Net::Amazon::Validate::ItemSearch::de::Kitchen;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Kitchen!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Kitchen - valid search indicies
