...
package Net::Amazon::Validate::ItemSearch::de::Electronics;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Electronics!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Electronics - valid search indicies
for the de locale and the Electronics SearchIndex.
