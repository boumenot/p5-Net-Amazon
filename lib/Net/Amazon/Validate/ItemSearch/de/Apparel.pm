...
package Net::Amazon::Validate::ItemSearch::de::Apparel;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Apparel!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Apparel - valid search indicies
for the de locale and the Apparel SearchIndex.
