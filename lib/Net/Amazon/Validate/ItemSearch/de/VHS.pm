...
package Net::Amazon::Validate::ItemSearch::de::VHS;
...
sub find_match {
    ...
    die "$value is not a valid value for de::VHS!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::VHS - valid search indicies
for the de locale and the VHS SearchIndex.
