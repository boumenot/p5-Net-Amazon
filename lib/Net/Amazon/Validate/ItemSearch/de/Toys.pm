...
package Net::Amazon::Validate::ItemSearch::de::Toys;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Toys!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Toys - valid search indicies
for the de locale and the Toys SearchIndex.
