...
package Net::Amazon::Validate::ItemSearch::de::HealthPersonalCare;
...
sub find_match {
    ...
    die "$value is not a valid value for de::HealthPersonalCare!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::HealthPersonalCare - valid search indicies
for the de locale and the HealthPersonalCare SearchIndex.
