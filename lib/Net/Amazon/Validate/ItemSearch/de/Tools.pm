...
package Net::Amazon::Validate::ItemSearch::de::Tools;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Tools!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Tools - valid search indicies
for the de locale and the Tools SearchIndex.
