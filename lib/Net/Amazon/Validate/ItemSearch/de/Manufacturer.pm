...
package Net::Amazon::Validate::ItemSearch::de::Manufacturer;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Manufacturer!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Manufacturer - valid search indices for the de locale and the Manufacturer operation.
