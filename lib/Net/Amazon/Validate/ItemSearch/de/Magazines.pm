...
package Net::Amazon::Validate::ItemSearch::de::Magazines;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Magazines!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Magazines - valid search indicies
for the de locale and the Magazines SearchIndex.
