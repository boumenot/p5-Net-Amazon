...
package Net::Amazon::Validate::ItemSearch::de::Classical;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Classical!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Classical - valid search indicies
for the de locale and the Classical SearchIndex.
