...
package Net::Amazon::Validate::ItemSearch::de::Beauty;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Beauty!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Beauty - valid search indicies
