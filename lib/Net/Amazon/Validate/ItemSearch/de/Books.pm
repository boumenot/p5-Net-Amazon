...
package Net::Amazon::Validate::ItemSearch::de::Books;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Books!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Books - valid search indicies
for the de locale and the Books SearchIndex.
