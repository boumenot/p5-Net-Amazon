...
package Net::Amazon::Validate::ItemSearch::de::Availability;
...
sub find_match {
    ...
    die "$value is not a valid value for de::Availability!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::Availability - valid search indices for the de locale and the Availability operation.
