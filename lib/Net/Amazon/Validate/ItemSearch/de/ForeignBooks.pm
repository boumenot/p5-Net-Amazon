...
package Net::Amazon::Validate::ItemSearch::de::ForeignBooks;
...
sub find_match {
    ...
    die "$value is not a valid value for de::ForeignBooks!\n";
}
...
Net::Amazon::Validate::ItemSearch::de::ForeignBooks - valid search indicies
for the de locale and the ForeignBooks SearchIndex.
