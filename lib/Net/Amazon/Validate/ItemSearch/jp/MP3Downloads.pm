...
package Net::Amazon::Validate::ItemSearch::jp::MP3Downloads;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::MP3Downloads!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::MP3Downloads - valid search indicies
for the jp locale and the MP3Downloads SearchIndex.
