...
package Net::Amazon::Validate::ItemSearch::jp::Beauty;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Beauty!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Beauty - valid search indicies
for the jp locale and the Beauty SearchIndex.
