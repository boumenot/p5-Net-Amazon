...
package Net::Amazon::Validate::ItemSearch::jp::Marketplace;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Marketplace!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Marketplace - valid search indicies
for the jp locale and the Marketplace SearchIndex.
