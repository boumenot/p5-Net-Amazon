...
package Net::Amazon::Validate::ItemSearch::jp::Automotive;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Automotive!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Automotive - valid search indicies
for the jp locale and the Automotive SearchIndex.
