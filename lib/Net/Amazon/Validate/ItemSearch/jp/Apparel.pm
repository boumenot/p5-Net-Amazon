...
package Net::Amazon::Validate::ItemSearch::jp::Apparel;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Apparel!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Apparel - valid search indicies
