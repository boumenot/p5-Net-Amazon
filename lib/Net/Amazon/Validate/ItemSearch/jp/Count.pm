...
package Net::Amazon::Validate::ItemSearch::jp::Count;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Count!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Count - valid search indices for the jp locale and the Count operation.
