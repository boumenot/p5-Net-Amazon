...
package Net::Amazon::Validate::ItemSearch::jp::Title;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Title!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Title - valid search indices for the jp locale and the Title operation.
