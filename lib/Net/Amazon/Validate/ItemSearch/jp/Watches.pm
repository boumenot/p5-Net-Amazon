...
package Net::Amazon::Validate::ItemSearch::jp::Watches;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Watches!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Watches - valid search indicies
for the jp locale and the Watches SearchIndex.
