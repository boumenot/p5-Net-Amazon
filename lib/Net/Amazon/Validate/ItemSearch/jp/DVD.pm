...
package Net::Amazon::Validate::ItemSearch::jp::DVD;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::DVD!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::DVD - valid search indicies
for the jp locale and the DVD SearchIndex.
