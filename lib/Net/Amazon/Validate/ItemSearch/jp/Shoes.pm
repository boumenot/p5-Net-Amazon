...
package Net::Amazon::Validate::ItemSearch::jp::Shoes;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Shoes!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Shoes - valid search indicies
for the jp locale and the Shoes SearchIndex.
