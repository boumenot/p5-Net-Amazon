...
package Net::Amazon::Validate::ItemSearch::jp::Kitchen;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Kitchen!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Kitchen - valid search indicies
