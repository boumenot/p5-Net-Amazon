...
package Net::Amazon::Validate::ItemSearch::jp::VHS;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::VHS!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::VHS - valid search indicies
for the jp locale and the VHS SearchIndex.
