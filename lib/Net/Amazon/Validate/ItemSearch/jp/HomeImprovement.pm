...
package Net::Amazon::Validate::ItemSearch::jp::HomeImprovement;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::HomeImprovement!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::HomeImprovement - valid search indicies
for the jp locale and the HomeImprovement SearchIndex.
