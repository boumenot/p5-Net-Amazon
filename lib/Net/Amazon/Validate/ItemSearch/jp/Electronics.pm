...
package Net::Amazon::Validate::ItemSearch::jp::Electronics;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Electronics!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Electronics - valid search indicies
