...
package Net::Amazon::Validate::ItemSearch::jp::OfficeProducts;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::OfficeProducts!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::OfficeProducts - valid search indicies
for the jp locale and the OfficeProducts SearchIndex.
