...
package Net::Amazon::Validate::ItemSearch::jp::Books;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::Books!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::Books - valid search indicies
for the jp locale and the Books SearchIndex.
