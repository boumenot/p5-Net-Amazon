...
package Net::Amazon::Validate::ItemSearch::jp::MusicalInstruments;
...
sub find_match {
    ...
    die "$value is not a valid value for jp::MusicalInstruments!\n";
}
...
Net::Amazon::Validate::ItemSearch::jp::MusicalInstruments - valid search indicies
for the jp locale and the MusicalInstruments SearchIndex.
