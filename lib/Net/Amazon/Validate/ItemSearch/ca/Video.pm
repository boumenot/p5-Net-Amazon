...
package Net::Amazon::Validate::ItemSearch::ca::Video;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::Video!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::Video - valid search indicies
for the ca locale and the Video SearchIndex.
