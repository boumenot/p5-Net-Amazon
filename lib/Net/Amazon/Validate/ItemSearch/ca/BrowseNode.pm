...
package Net::Amazon::Validate::ItemSearch::ca::BrowseNode;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::BrowseNode!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::BrowseNode - valid search indices for the ca locale and the BrowseNode operation.
