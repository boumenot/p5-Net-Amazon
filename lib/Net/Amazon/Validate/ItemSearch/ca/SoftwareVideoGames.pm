...
package Net::Amazon::Validate::ItemSearch::ca::SoftwareVideoGames;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::SoftwareVideoGames!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::SoftwareVideoGames;
