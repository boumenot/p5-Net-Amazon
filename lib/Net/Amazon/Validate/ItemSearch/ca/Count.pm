...
package Net::Amazon::Validate::ItemSearch::ca::Count;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::Count!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::Count - valid search indices for the ca locale and the Count operation.
