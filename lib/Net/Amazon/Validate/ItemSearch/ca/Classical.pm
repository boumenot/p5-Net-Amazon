...
package Net::Amazon::Validate::ItemSearch::ca::Classical;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::Classical!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::Classical - valid search indicies
