...
package Net::Amazon::Validate::ItemSearch::ca::MerchantId;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::MerchantId!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::MerchantId - valid search indices for the ca locale and the MerchantId operation.
