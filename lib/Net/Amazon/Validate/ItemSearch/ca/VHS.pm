...
package Net::Amazon::Validate::ItemSearch::ca::VHS;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::VHS!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::VHS - valid search indicies
for the ca locale and the VHS SearchIndex.
