...
package Net::Amazon::Validate::ItemSearch::ca::Books;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::Books!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::Books - valid search indicies
for the ca locale and the Books SearchIndex.
