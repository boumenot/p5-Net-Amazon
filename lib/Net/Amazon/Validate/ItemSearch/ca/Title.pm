...
package Net::Amazon::Validate::ItemSearch::ca::Title;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::Title!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::Title - valid search indices for the ca locale and the Title operation.
