...
package Net::Amazon::Validate::ItemSearch::ca::ForeignBooks;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::ForeignBooks!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::ForeignBooks - valid search indicies
for the ca locale and the ForeignBooks SearchIndex.
