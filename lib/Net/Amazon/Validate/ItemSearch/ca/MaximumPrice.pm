...
package Net::Amazon::Validate::ItemSearch::ca::MaximumPrice;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::MaximumPrice!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::MaximumPrice - valid search indices for the ca locale and the MaximumPrice operation.
