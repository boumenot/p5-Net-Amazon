...
package Net::Amazon::Validate::ItemSearch::ca::Music;
...
sub find_match {
    ...
    die "$value is not a valid value for ca::Music!\n";
}
...
Net::Amazon::Validate::ItemSearch::ca::Music - valid search indicies
for the ca locale and the Music SearchIndex.
