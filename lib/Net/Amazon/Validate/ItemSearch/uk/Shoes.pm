...
package Net::Amazon::Validate::ItemSearch::uk::Shoes;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Shoes!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Shoes - valid search indicies
for the uk locale and the Shoes SearchIndex.
