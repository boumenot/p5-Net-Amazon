...
package Net::Amazon::Validate::ItemSearch::uk::DVD;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::DVD!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::DVD - valid search indicies
for the uk locale and the DVD SearchIndex.
