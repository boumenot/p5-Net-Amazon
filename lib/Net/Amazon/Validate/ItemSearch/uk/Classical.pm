...
package Net::Amazon::Validate::ItemSearch::uk::Classical;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Classical!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Classical - valid search indicies
