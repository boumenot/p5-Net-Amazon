...
package Net::Amazon::Validate::ItemSearch::uk::MP3Downloads;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::MP3Downloads!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::MP3Downloads;
