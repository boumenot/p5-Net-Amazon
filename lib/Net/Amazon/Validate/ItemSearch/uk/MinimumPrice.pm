...
package Net::Amazon::Validate::ItemSearch::uk::MinimumPrice;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::MinimumPrice!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::MinimumPrice - valid search indices for the uk locale and the MinimumPrice operation.
