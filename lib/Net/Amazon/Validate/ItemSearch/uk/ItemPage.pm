...
package Net::Amazon::Validate::ItemSearch::uk::ItemPage;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::ItemPage!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::ItemPage - valid search indices for the uk locale and the ItemPage operation.
