...
package Net::Amazon::Validate::ItemSearch::uk::MerchantId;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::MerchantId!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::MerchantId - valid search indices for the uk locale and the MerchantId operation.
