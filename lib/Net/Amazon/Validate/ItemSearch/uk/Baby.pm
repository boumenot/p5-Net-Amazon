...
package Net::Amazon::Validate::ItemSearch::uk::Baby;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Baby!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Baby - valid search indicies
for the uk locale and the Baby SearchIndex.
