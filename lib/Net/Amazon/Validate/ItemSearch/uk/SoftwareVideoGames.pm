...
package Net::Amazon::Validate::ItemSearch::uk::SoftwareVideoGames;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::SoftwareVideoGames!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::SoftwareVideoGames - valid search indicies
for the uk locale and the SoftwareVideoGames SearchIndex.
