...
package Net::Amazon::Validate::ItemSearch::uk::BrowseNode;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::BrowseNode!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::BrowseNode - valid search indices for the uk locale and the BrowseNode operation.
