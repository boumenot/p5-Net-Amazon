...
package Net::Amazon::Validate::ItemSearch::uk::Magazines;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Magazines!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Magazines - valid search indices for the uk locale and the Magazines operation.
