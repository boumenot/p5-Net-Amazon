...
package Net::Amazon::Validate::ItemSearch::uk::Music;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Music!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Music - valid search indicies
for the uk locale and the Music SearchIndex.
