...
package Net::Amazon::Validate::ItemSearch::uk::Electronics;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Electronics!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Electronics - valid search indicies
for the uk locale and the Electronics SearchIndex.
