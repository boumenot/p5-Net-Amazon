...
package Net::Amazon::Validate::ItemSearch::uk::Apparel;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Apparel!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Apparel - valid search indicies
for the uk locale and the Apparel SearchIndex.
