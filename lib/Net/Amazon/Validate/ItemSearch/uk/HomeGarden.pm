...
package Net::Amazon::Validate::ItemSearch::uk::HomeGarden;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::HomeGarden!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::HomeGarden - valid search indicies
for the uk locale and the HomeGarden SearchIndex.
