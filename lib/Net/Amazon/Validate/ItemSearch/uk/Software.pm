...
package Net::Amazon::Validate::ItemSearch::uk::Software;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Software!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Software - valid search indicies
for the uk locale and the Software SearchIndex.
