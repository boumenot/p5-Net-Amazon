...
package Net::Amazon::Validate::ItemSearch::uk::OutdoorLiving;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::OutdoorLiving!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::OutdoorLiving;
