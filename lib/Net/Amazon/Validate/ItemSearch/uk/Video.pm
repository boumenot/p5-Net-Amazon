...
package Net::Amazon::Validate::ItemSearch::uk::Video;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Video!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Video - valid search indicies
for the uk locale and the Video SearchIndex.
