...
package Net::Amazon::Validate::ItemSearch::uk::MusicTracks;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::MusicTracks!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::MusicTracks - valid search indicies
for the uk locale and the MusicTracks SearchIndex.
