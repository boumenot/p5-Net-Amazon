...
package Net::Amazon::Validate::ItemSearch::uk::Performer;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Performer!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Performer - valid search indices for the uk locale and the Performer operation.
