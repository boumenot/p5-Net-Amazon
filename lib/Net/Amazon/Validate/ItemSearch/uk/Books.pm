...
package Net::Amazon::Validate::ItemSearch::uk::Books;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Books!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Books - valid search indicies
for the uk locale and the Books SearchIndex.
