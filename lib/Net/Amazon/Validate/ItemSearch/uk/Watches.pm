...
package Net::Amazon::Validate::ItemSearch::uk::Watches;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Watches!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Watches - valid search indicies
for the uk locale and the Watches SearchIndex.
