...
package Net::Amazon::Validate::ItemSearch::uk::Beauty;
...
sub find_match {
    ...
    die "$value is not a valid value for uk::Beauty!\n";
}
...
Net::Amazon::Validate::ItemSearch::uk::Beauty - valid search indicies
for the uk locale and the Beauty SearchIndex.
