...
package Net::Amazon::Validate::ItemSearch::it::Baby;
...
sub find_match {
    ...
    die "$value is not a valid value for it::Baby!\n";
}
...
Net::Amazon::Validate::ItemSearch::it::Baby - valid search indicies
for the it locale and the Baby SearchIndex.
