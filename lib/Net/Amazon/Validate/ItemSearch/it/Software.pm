...
package Net::Amazon::Validate::ItemSearch::it::Software;
...
sub find_match {
    ...
    die "$value is not a valid value for it::Software!\n";
}
...
Net::Amazon::Validate::ItemSearch::it::Software - valid search indicies
for the it locale and the Software SearchIndex.
