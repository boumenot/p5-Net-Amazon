...
package Net::Amazon::Validate::ItemSearch::it::ForeignBooks;
...
sub find_match {
    ...
    die "$value is not a valid value for it::ForeignBooks!\n";
}
...
Net::Amazon::Validate::ItemSearch::it::ForeignBooks - valid search indicies
for the it locale and the ForeignBooks SearchIndex.
