...
package Net::Amazon::Validate::ItemSearch::it::DVD;
...
sub find_match {
    ...
    die "$value is not a valid value for it::DVD!\n";
}
...
Net::Amazon::Validate::ItemSearch::it::DVD - valid search indicies
for the it locale and the DVD SearchIndex.
