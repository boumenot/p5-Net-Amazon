...
package Net::Amazon::Validate::ItemSearch::it::Electronics;
...
sub find_match {
    ...
    die "$value is not a valid value for it::Electronics!\n";
}
...
Net::Amazon::Validate::ItemSearch::it::Electronics - valid search indicies
for the it locale and the Electronics SearchIndex.
