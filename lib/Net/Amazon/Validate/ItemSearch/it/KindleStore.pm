...
package Net::Amazon::Validate::ItemSearch::it::KindleStore;
...
sub find_match {
    ...
    die "$value is not a valid value for it::KindleStore!\n";
}
...
Net::Amazon::Validate::ItemSearch::it::KindleStore - valid search indicies
for the it locale and the KindleStore SearchIndex.
