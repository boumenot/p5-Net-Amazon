...
package Net::Amazon::Validate::ItemSearch::it::Music;
...
sub find_match {
    ...
    die "$value is not a valid value for it::Music!\n";
}
...
Net::Amazon::Validate::ItemSearch::it::Music - valid search indicies
for the it locale and the Music SearchIndex.
