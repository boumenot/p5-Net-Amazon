...
package Net::Amazon::Validate::ItemSearch::it::VideoGames;
...
sub find_match {
    ...
    die "$value is not a valid value for it::VideoGames!\n";
}
...
Net::Amazon::Validate::ItemSearch::it::VideoGames - valid search indicies
for the it locale and the VideoGames SearchIndex.
