...
package Net::Amazon::Validate::ItemSearch::it::Lighting;
...
sub find_match {
    ...
    die "$value is not a valid value for it::Lighting!\n";
}
...
Net::Amazon::Validate::ItemSearch::it::Lighting - valid search indicies
for the it locale and the Lighting SearchIndex.
