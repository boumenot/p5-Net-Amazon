...
package Net::Amazon::Validate::ItemSearch::it::Kitchen;
...
sub find_match {
    ...
    die "$value is not a valid value for it::Kitchen!\n";
}
...
Net::Amazon::Validate::ItemSearch::it::Kitchen - valid search indicies
for the it locale and the Kitchen SearchIndex.
